...
function rssfeedclass(adapter) {
    ...
    this.initCmdStates = function() {   
        this.log.silly('initCmdStates');           
        let key = 'forceRefresh';
        let stateTemplate = this.sbRssFeedStatus[key];
        if (!stateTemplate.exist) {
            this.sbRssFeedStatus[key]=this.createState(stateTemplate,this.RssFeedPath);
        }
    };
    ...
    this.compareArticles = function(articles1,articles2) {
        this.log.silly('compareArticles');                
    ...
    this.filterattributes = function(filter,attributes) {
        var obj = {};
        this.log.silly('filterattributes');
