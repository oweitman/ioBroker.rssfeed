let index_cjs$3, init_1, vis2rssfeedWidgets__mf_v__runtimeInit__mf_v__;
let __tla = (async () => {
  let index_cjs$2, polyfills_cjs$1;
  index_cjs$3 = {};
  index_cjs$2 = {};
  polyfills_cjs$1 = {};
  function _extends$2() {
  ...
  const getProcessEnv = function() {
    ...
    const n = t.split(r), o = getProcessEnv().NODE_ENV === "development" && e, i = "*", a = (s) => s.startsWith("http") || s.includes(MANIFEST_EXT);
    if (n.length >= 2) {
      let [s, ...l] = n;
      t.startsWith(r) && (s = n.slice(0, 2).join(r), l = [
        o || n.slice(2).join(r)
      ]);
      let c = o || l.join(r);
      return a(c) ? {
  ...
  function generateSnapshotFromManifest(t, e = {}) {
    var r, n;
    const { remotes: o = {}, overrides: i = {}, version: a } = e;
    let s;
    ...
    if (!Object.keys(o).length) {
      ...
      u = ((d = t.remotes) == null ? void 0 : d.reduce((E, R) => {
        ...
        return c.includes($) ? T = i[$] : "version" in R ? T = R.version : T = R.entry, E[$] = {
          matchedVersion: T
        }, E;
      }, {})) || {};
    }
    Object.keys(o).forEach((E) => u[E] = {
      matchedVersion: c.includes(E) ? i[E] : o[E]
    });
    const { remoteEntry: { path: h, name: m, type: _ }, types: y, buildInfo: { buildVersion: p }, globalName: g, ssrRemoteEntry: I } = t.metaData, { exposes: b } = t;
    let S = {
      version: a || "",
      buildVersion: p,
      globalName: g,
    ...
    if ((n = t.metaData) != null && n.prefetchEntry) {
      const { path: E, name: R, type: T } = t.metaData.prefetchEntry;
      S = polyfills$1._({}, S, {
  ...
  function createScript(t) {
    ...
    if (!e) {
      const s = t.attrs;
      e = document.createElement("script"), e.type = (s == null ? void 0 : s.type) === "module" ? "module" : "text/javascript";
      let l;
      t.createScriptHook && (l = t.createScriptHook(t.url, t.attrs), l instanceof HTMLScriptElement ? e = l : typeof l == "object" && ("script" in l && l.script && (e = l.script), "timeout" in l && l.timeout && (n = l.timeout))), e.src || (e.src = t.url), s && !l && Object.keys(s).forEach((c) => {
    ...
    const a = async (s, l) => {
      clearTimeout(o);
      const c = () => {
        (l == null ? void 0 : l.type) === "error" ? (t == null ? void 0 : t.onErrorCallback) && (t == null ? void 0 : t.onErrorCallback(l)) : (t == null ? void 0 : t.cb) && (t == null ? void 0 : t.cb());
      };
      if (e && (e.onerror = null, e.onload = null, safeWrapper$1(() => {
        const { needDeleteScript: u = true } = t;
        u && (e == null ? void 0 : e.parentNode) && e.parentNode.removeChild(e);
      }), s && typeof s == "function")) {
        const u = s(l);
    ...
    return e.onerror = a.bind(null, e.onerror), e.onload = a.bind(null, e.onload), o = setTimeout(() => {
  ...
  function createLink(t) {
    ...
    for (let i = 0; i < n.length; i++) {
      const a = n[i], s = a.getAttribute("href"), l = a.getAttribute("rel");
    ...
    const o = (i, a) => {
      const s = () => {
        (a == null ? void 0 : a.type) === "error" ? (t == null ? void 0 : t.onErrorCallback) && (t == null ? void 0 : t.onErrorCallback(a)) : (t == null ? void 0 : t.cb) && (t == null ? void 0 : t.cb());
      };
      if (e && (e.onerror = null, e.onload = null, safeWrapper$1(() => {
        const { needDeleteLink: l = true } = t;
        l && (e == null ? void 0 : e.parentNode) && e.parentNode.removeChild(e);
      }), i)) {
        const l = i(a);
        return s(), l;
      }
  ...
  function importNodeModule(t) {
    ...
    return new Function("name", "return import(name)")(t).then((r) => r).catch((r) => {
      throw console.error(`Error importing module ${t}:`, r), r;
    });
  }
  const loadNodeFetch = async () => {
    ...
    const o = await ((i, a) => r.lifecycle.fetch.emit(i, a))(t, e || {});
  ...
  async function loadModule(t, e) {
    const { fetch: r, vm: n } = e, i = await (await r(t)).text(), a = new n.SourceTextModule(i, {
      importModuleDynamically: async (s, l) => {
        const c = new URL(s, t).href;
        return loadModule(c, e);
      }
    });
    return await a.link(async (s) => {
  ...
  function normalizeOptions(t, e, r) {
    return function(n) {
      ...
      if (n === true) return e;
      if (n && typeof n == "object") return polyfills$1._({}, e, n);
...
`);
  ...
  function setGlobalDefaultVal(t) {
    ...
    var c;
    (c = (n = t.__FEDERATION__).moduleInfo) != null || (n.moduleInfo = {});
    var u;
    (u = (o = t.__FEDERATION__).__SHARE__) != null || (o.__SHARE__ = {});
    var d;
    (d = (i = t.__FEDERATION__).__MANIFEST_LOADING__) != null || (i.__MANIFEST_LOADING__ = {});
    var h;
    (h = (a = t.__FEDERATION__).__PRELOADED_MAP__) != null || (a.__PRELOADED_MAP__ = /* @__PURE__ */ new Map());
  }
  ...
  function setGlobalFederationConstructor(t, e = sdk.isDebugMode()) {
    e && (CurrentGlobal.__FEDERATION__.__DEBUG_CONSTRUCTOR__ = t, CurrentGlobal.__FEDERATION__.__DEBUG_CONSTRUCTOR_VERSION__ = "0.17.1");
  }
  ...
  const getGlobalSnapshot = () => nativeGlobal.__FEDERATION__.moduleInfo, getTargetSnapshotInfoByModuleInfo = (t, e) => {
    ...
    if ("version" in t && t.version) {
      const { version: o } = t, i = polyfills._object_without_properties_loose(t, [
        "version"
      ]), a = getFMId(i), s = getInfoWithoutType(nativeGlobal.__FEDERATION__.moduleInfo, a).value;
      if ((s == null ? void 0 : s.version) === o) return s;
    }
  ...
  function parseHyphen(t) {
    return t.replace(parseRegex(hyphenRange), (e, r, n, o, i, a, s, l, c, u, d, h) => (isXVersion(n) ? r = "" : isXVersion(o) ? r = `>=${n}.0.0` : isXVersion(i) ? r = `>=${n}.${o}.0` : r = `>=${r}`, isXVersion(c) ? l = "" : isXVersion(u) ? l = `<${Number(c) + 1}.0.0-0` : isXVersion(d) ? l = `<${c}.${Number(u) + 1}.0-0` : h ? l = `<=${c}.${u}.${d}-${h}` : l = `<=${l}`, `${r} ${l}`.trim()));
  }
  ...
  function parseCarets(t) {
    return t.trim().split(/\s+/).map((e) => e.replace(parseRegex(caret), (r, n, o, i, a) => isXVersion(n) ? "" : isXVersion(o) ? `>=${n}.0.0 <${Number(n) + 1}.0.0-0` : isXVersion(i) ? n === "0" ? `>=${n}.${o}.0 <${n}.${Number(o) + 1}.0-0` : `>=${n}.${o}.0 <${Number(n) + 1}.0.0-0` : a ? n === "0" ? o === "0" ? `>=${n}.${o}.${i}-${a} <${n}.${o}.${Number(i) + 1}-0` : `>=${n}.${o}.${i}-${a} <${n}.${Number(o) + 1}.0-0` : `>=${n}.${o}.${i}-${a} <${Number(n) + 1}.0.0-0` : n === "0" ? o === "0" ? `>=${n}.${o}.${i} <${n}.${o}.${Number(i) + 1}-0` : `>=${n}.${o}.${i} <${n}.${Number(o) + 1}.0-0` : `>=${n}.${o}.${i} <${Number(n) + 1}.0.0-0`)).join(" ");
  }
  function parseTildes(t) {
    return t.trim().split(/\s+/).map((e) => e.replace(parseRegex(tilde), (r, n, o, i, a) => isXVersion(n) ? "" : isXVersion(o) ? `>=${n}.0.0 <${Number(n) + 1}.0.0-0` : isXVersion(i) ? `>=${n}.${o}.0 <${n}.${Number(o) + 1}.0-0` : a ? `>=${n}.${o}.${i}-${a} <${n}.${Number(o) + 1}.0-0` : `>=${n}.${o}.${i} <${n}.${Number(o) + 1}.0-0`)).join(" ");
  }
  function parseXRanges(t) {
    return t.split(/\s+/).map((e) => e.trim().replace(parseRegex(xRange), (r, n, o, i, a, s) => {
      const l = isXVersion(o), c = l || isXVersion(i), u = c || isXVersion(a);
      return n === "=" && u && (n = ""), s = "", l ? n === ">" || n === "<" ? "<0.0.0-0" : "*" : n && u ? (c && (i = 0), a = 0, n === ">" ? (n = ">=", c ? (o = Number(o) + 1, i = 0, a = 0) : (i = Number(i) + 1, a = 0)) : n === "<=" && (n = "<", c ? o = Number(o) + 1 : i = Number(i) + 1), n === "<" && (s = "-0"), `${n + o}.${i}.${a}${s}`) : c ? `>=${o}.0.0${s} <${Number(o) + 1}.0.0-0` : u ? `>=${o}.${i}.0${s} <${o}.${Number(i) + 1}.0-0` : r;
    })).join(" ");
  }
  ...
  function satisfy(t, e) {
    ...
    const [, n, , o, i, a, s] = r, l = {
      operator: n,
      version: combineVersion(o, i, a, s),
      major: o,
      minor: i,
      patch: a,
  ...
  function formatShare(t, e, r, n) {
    let o;
    "get" in t ? o = t.get : "lib" in t ? o = () => Promise.resolve(t.lib) : o = () => Promise.resolve(() => {
    ...
    return polyfills._extends({
      ...
      strategy: ((s = t.strategy) != null ? s : n) || "version-first"
    });
  }
  function formatShareConfigs(t, e) {
    const r = e.shared || {}, n = e.name, o = Object.keys(r).reduce((a, s) => {
      const l = arrayOptions(r[s]);
      return a[s] = a[s] || [], l.forEach((c) => {
        a[s].push(formatShare(c, n, s, e.shareStrategy));
      }), a;
  ...
  function versionLt(t, e) {
    const r = (n) => {
      if (!Number.isNaN(Number(n))) {
        const i = n.split(".");
        let a = n;
        for (let s = 0; s < 3 - i.length; s++) a += ".0";
        return a;
      }
      return n;
    };
  ...
  function findSingletonVersionOrderByLoaded(t, e, r) {
    const n = t[e][r], o = function(i, a) {
      ...
      return s(n[a]) ? s(n[i]) ? !!versionLt(i, a) : true : s(n[i]) ? false : versionLt(i, a);
    };
    return findVersion(t[e][r], o);
  }
  ...
  function getRegisteredShare(t, e, r, n) {
    if (!t) return;
    const { shareConfig: o, scope: i = DEFAULT_SCOPE, strategy: a } = r, s = Array.isArray(i) ? i : [
      i
    ];
    for (const l of s) if (o && t[l] && t[l][e]) {
      const { requiredVersion: c } = o, d = getFindShareFunction(a)(t, l, e), h = () => {
        if (o.singleton) {
          if (typeof c == "string" && !satisfy(d, c)) {
            ...
            o.strictVersion ? error(y) : warn(y);
          }
          return t[l][e][d];
        } else {
          if (c === false || c === "*" || satisfy(d, c)) return t[l][e][d];
          for (const [y, p] of Object.entries(t[l][e])) if (satisfy(y, c)) return p;
        }
      }, m = {
        shareScopeMap: t,
        scope: l,
  ...
  function getTargetSharedOptions(t) {
    const { pkgName: e, extraOptions: r, shareInfos: n } = t, o = (s) => {
      ...
      const u = findVersion(l, function(d, h) {
        return !isLoaded(l[d]) && versionLt(d, h);
      });
      return l[u];
    };
    var i;
    const a = (i = r == null ? void 0 : r.resolver) != null ? i : o;
  ...
  function registerPlugins$1(t, e) {
    ...
    return r.length > 0 && r.forEach((o) => {
      (t == null ? void 0 : t.find((i) => i.name !== o.name)) && t.push(o);
  ...
  function handleRemoteEntryLoaded(t, e, r) {
    ...
    return assert(o, errorCodes$1.getShortErrorMsg(errorCodes$1.RUNTIME_001, errorCodes$1.runtimeDescMap, {
      remoteName: t,
      remoteEntryUrl: r,
      remoteEntryKey: n
    })), o;
  }
  async function loadEntryScript({ name: t, globalName: e, entry: r, loaderHook: n }) {
    const { entryExports: o } = getRemoteEntryExports(t, e);
    return o || sdk.loadScript(r, {
      attrs: {},
      createScriptHook: (i, a) => {
        const s = n.lifecycle.createScript.emit({
          url: i,
          attrs: a
        });
        if (s && (s instanceof HTMLScriptElement || "script" in s || "timeout" in s)) return s;
      }
  ...
  async function loadEntryDom({ remoteInfo: t, remoteEntryExports: e, loaderHook: r }) {
    const { entry: n, entryGlobalName: o, name: i, type: a } = t;
    switch (a) {
      case "esm":
      case "module":
        return loadEsmEntry({
  ...
  async function loadEntryNode({ remoteInfo: t, loaderHook: e }) {
    const { entry: r, entryGlobalName: n, name: o, type: i } = t, { entryExports: a } = getRemoteEntryExports(o, n);
    return a || sdk.loadScriptNode(r, {
      ...
      loaderHook: {
        createScriptHook: (s, l = {}) => {
          ...
          if (c && "url" in c) return c;
        }
      }
    }).then(() => handleRemoteEntryLoaded(o, n, r)).catch((s) => {
      throw s;
    });
  }
  ...
  async function getRemoteEntry({ origin: t, remoteEntryExports: e, remoteInfo: r }) {
    const n = getRemoteEntryUniqueKey(r);
    if (e) return e;
    if (!globalLoading[n]) {
      const o = t.remoteHandler.hooks.lifecycle.loadEntry, i = t.loaderHook;
      globalLoading[n] = o.emit({
        loaderHook: i,
        remoteInfo: r,
        remoteEntryExports: e
      }).then((a) => a || ((typeof ENV_TARGET < "u" ? ENV_TARGET === "web" : sdk.isBrowserEnv()) ? loadEntryDom({
        remoteInfo: r,
        remoteEntryExports: e,
        loaderHook: i
      }) : loadEntryNode({
  ...
  function preloadAssets(t, e, r, n = true) {
    const { cssAssets: o, jsAssetsWithoutEntry: i, entryAssets: a } = r;
 ...
 ${sdk.safeToString(this.remoteInfo)}`), this.remoteEntryExports = e, this.remoteEntryExports;
    ...
    async get(e, r, n, o) {
      const { loadFactory: i = true } = n || {
        loadFactory: true
      }, a = await this.getEntry();
      if (!this.inited) {
        const d = this.host.shareScopeMap, h = Array.isArray(this.remoteInfo.shareScope) ? this.remoteInfo.shareScope : [
          this.remoteInfo.shareScope
        ];
        h.length || h.push("default"), h.forEach((g) => {
          d[g] || (d[g] = {});
        });
        const m = d[h[0]], _ = [], y = {
          version: this.remoteInfo.version || "",
          shareScopeKeys: Array.isArray(this.remoteInfo.shareScope) ? h : this.remoteInfo.shareScope || "default"
        };
        ...
        typeof (a == null ? void 0 : a.init) > "u" && error(errorCodes$1.getShortErrorMsg(errorCodes$1.RUNTIME_002, errorCodes$1.runtimeDescMap, {
          hostName: this.host.name,
          remoteName: this.remoteInfo.name,
          remoteEntryUrl: this.remoteInfo.entry,
          remoteEntryKey: this.remoteInfo.entryGlobalName
        })), await a.init(p.shareScope, p.initScope, p.remoteEntryInitOptions), await this.host.hooks.lifecycle.initContainer.emit(polyfills._extends({}, p, {
          id: e,
          remoteSnapshot: o,
          remoteEntryExports: a
        }));
      }
      this.lib = a, this.inited = true;
      let s;
  ...
  class AsyncHook extends SyncHook {
    emit(...e) {
      ...
      if (n.length > 0) {
        let o = 0;
        const i = (a) => a === false ? false : o < n.length ? Promise.resolve(n[o++].apply(null, e)).then(i) : a;
        r = i();
      }
  ...
  class AsyncWaterfallHook extends SyncHook {
    emit(e) {
      ...
      if (r.length > 0) {
        let n = 0;
        const o = (a) => (warn(a), this.onerror(a), e), i = (a) => {
          if (checkReturnData(e, a)) {
            if (e = a, n < r.length) try {
  ...
  class PluginSystem {
    applyPlugin(e, r) {
      ...
      const n = e.name;
      assert(n, "A name must be provided by the plugin."), this.registerPlugins[n] || (this.registerPlugins[n] = e, e.apply == null || e.apply.call(e, r), Object.keys(this.lifecycle).forEach((o) => {
        const i = e[o];
  ...
  function snapshotPlugin() {
    return {
      ...
      async afterResolve(t) {
        const { remote: e, pkgNameOrAlias: r, expose: n, origin: o, remoteInfo: i, id: a } = t;
        if (!isRemoteInfoWithEntry(e) || !isPureRemoteEntry(e)) {
          const { remoteSnapshot: s, globalSnapshot: l } = await o.snapshotHandler.loadRemoteSnapshotInfo({
            moduleInfo: e,
            id: a
          });
          ...
          return u && preloadAssets(i, o, u, false), polyfills._extends({}, t, {
            remoteSnapshot: s
          });
        }
        return t;
  ...
  function traverseModuleInfo(t, e, r, n, o = {}, i) {
    ...
    if (l && !sdk.isManifestProvider(l) && (r(l, e, n), l.remotesInfo)) {
  ...
  function generatePreloadAssets(t, e, r, n, o) {
    const i = [], a = [], s = [], l = /* @__PURE__ */ new Set(), c = /* @__PURE__ */ new Set(), { options: u } = t, { preloadConfig: d } = e, { depsRemote: h } = d;
    if (traverseModuleInfo(n, r, (p, g, I) => {
      let b;
      if (I) b = d;
      else if (Array.isArray(h)) {
        const M = h.find((N) => N.nameOrAlias === g.name || N.nameOrAlias === g.alias);
        if (!M) return;
        b = defaultPreloadArgs(M);
      } else if (h === true) b = d;
      else return;
      const S = sdk.getResourceUrl(p, getRemoteEntryInfoFromSnapshot(p).url);
      S && s.push({
        name: g.name,
        moduleInfo: {
          name: g.name,
          ...
          entryGlobalName: "globalName" in p ? p.globalName : g.name,
          shareScope: "",
          version: "version" in p ? p.version : void 0
        },
        url: S
      });
      let E = "modules" in p ? p.modules : [];
      const R = normalizePreloadExposes(b.exposes);
      if (R.length && "modules" in p) {
        var T;
        E = p == null || (T = p.modules) == null ? void 0 : T.reduce((M, N) => ((R == null ? void 0 : R.indexOf(N.moduleName)) !== -1 && M.push(N), M), []);
      }
      function $(M) {
        const N = M.map((v) => sdk.getResourceUrl(p, v));
        return b.filter ? N.filter(b.filter) : N;
      }
      if (E) {
        const M = E.length;
        for (let N = 0; N < M; N++) {
          const v = E[N], A = `${g.name}/${v.moduleName}`;
          t.remoteHandler.hooks.lifecycle.handlePreloadModule.emit({
            id: v.moduleName === "." ? g.name : A,
            name: g.name,
            remoteSnapshot: p,
            preloadConfig: b,
            remote: g,
            origin: t
          }), !getPreloaded(A) && (b.resourceCategory === "all" ? (i.push(...$(v.assets.css.async)), i.push(...$(v.assets.css.sync)), a.push(...$(v.assets.js.async)), a.push(...$(v.assets.js.sync))) : (b.resourceCategory = "sync") && (i.push(...$(v.assets.css.sync)), a.push(...$(v.assets.js.sync))), setPreloaded(A));
        }
      }
    ...
    const _ = a.filter((p) => !l.has(p) && !isExisted("script", p));
    return {
      cssAssets: i.filter((p) => !c.has(p) && !isExisted("link", p)),
      jsAssetsWithoutEntry: _,
      entryAssets: s.filter((p) => !isExisted("script", p.url))
    };
  }
  const generatePreloadAssetsPlugin = function() {
    return {
      ...
      async generatePreloadAssets(t) {
        const { origin: e, preloadOptions: r, remoteInfo: n, remote: o, globalSnapshot: i, remoteSnapshot: a } = t;
        ...
        } : (assignRemoteInfo(n, a), generatePreloadAssets(e, r, n, i, a)) : {
          cssAssets: [],
          jsAssetsWithoutEntry: [],
          entryAssets: []
        };
  ...
  class SnapshotHandler {
    async loadRemoteSnapshotInfo({ moduleInfo: e, id: r, expose: n }) {
      ...
      })), i && "remotesInfo" in i && !getInfoWithoutType(i.remotesInfo, e.name).value && ("version" in e || "entry" in e) && (i.remotesInfo = polyfills._extends({}, i == null ? void 0 : i.remotesInfo, {
        [e.name]: {
      ...
      let d, h;
      if (c) if (sdk.isManifestProvider(c)) {
        ...
        d = y, h = _;
      } else error(errorCodes$1.getShortErrorMsg(errorCodes$1.RUNTIME_007, errorCodes$1.runtimeDescMap, {
        hostName: e.name,
    ...
    async getManifestJson(e, r, n) {
      const o = async () => {
        ...
        const a = await o(), s = sdk.generateSnapshotFromManifest(a, {
          version: e
  ...
  class SharedHandler {
    ...
    async loadShare(e, r) {
      ...
      (o == null ? void 0 : o.scope) && await Promise.all(o.scope.map(async (c) => {
      ...
      assert(a, `Cannot find ${e} Share in the ${n.options.name}. Please ensure that the ${e} Share parameters have been injected`);
    ...
    initializeSharing(e = DEFAULT_SCOPE, r) {
      const { host: n } = this, o = r == null ? void 0 : r.from, i = r == null ? void 0 : r.strategy;
      ...
      const l = this.shareScopeMap, c = n.options.name;
      l[e] || (l[e] = {});
      const u = l[e], d = (_, y) => {
        var p;
        const { version: g, eager: I } = y;
        u[_] = u[_] || {};
        const b = u[_], S = b[g], E = !!(S && (S.eager || (p = S.shareConfig) != null && p.eager));
        (!S || S.strategy !== "loaded-first" && !S.loaded && (!I != !E ? I : c > S.from)) && (b[g] = y);
      }, h = (_) => _ && _.init && _.init(l[e], a), m = async (_) => {
        const { module: y } = await n.remoteHandler.getRemoteModuleAndOptions({
          id: _
        });
        if (y.getEntry) {
          let p;
          ...
          y.inited || (await h(p), y.inited = true);
        }
      };
      return Object.keys(n.options.shared).forEach((_) => {
        n.options.shared[_].forEach((p) => {
          p.scope.includes(e) && d(_, p);
        });
      }), (n.options.shareStrategy === "version-first" || i === "version-first") && n.options.remotes.forEach((_) => {
    ...
    loadShareSync(e, r) {
      ...
      (o == null ? void 0 : o.scope) && o.scope.forEach((s) => {
        this.initializeSharing(s, {
          strategy: o.strategy
        });
      });
      const i = getRegisteredShare(this.shareScopeMap, e, o, this.hooks.lifecycle.resolveShare), a = (s) => {
        s.useIn || (s.useIn = []), addUniqueItem(s.useIn, n.options.name);
      };
      if (i) {
        if (typeof i.lib == "function") return a(i), i.loaded || (i.loaded = true, i.from === n.options.name && (o.loaded = true)), i.lib;
      ...
      if (o.get) {
        ...
        if (s instanceof Promise) {
          const l = (r == null ? void 0 : r.from) === "build" ? errorCodes$1.RUNTIME_005 : errorCodes$1.RUNTIME_006;
          throw new Error(errorCodes$1.getShortErrorMsg(l, errorCodes$1.runtimeDescMap, {
            hostName: n.options.name,
            sharedPkgName: e
          }));
        }
        return o.lib = s, this.setShared({
          pkgName: e,
          loaded: true,
          from: n.options.name,
          lib: o.lib,
    ...
    setShared({ pkgName: e, shared: r, from: n, lib: o, loading: i, loaded: a, get: s }) {
      ...
      (Array.isArray(c) ? c : [
        ...
        if (this.shareScopeMap[h] || (this.shareScopeMap[h] = {}), this.shareScopeMap[h][e] || (this.shareScopeMap[h][e] = {}), !this.shareScopeMap[h][e][l]) {
          this.shareScopeMap[h][e][l] = polyfills._extends({
            version: l,
            scope: [
              "default"
            ]
            ...
            loaded: a,
            loading: i
          }), s && (this.shareScopeMap[h][e][l].get = s);
          return;
        }
        const m = this.shareScopeMap[h][e][l];
        i && !m.loading && (m.loading = i);
      });
    }
  ...
  class RemoteHandler {
    formatAndRegisterRemote(e, r) {
      return (r.remotes || []).reduce((o, i) => (this.registerRemote(i, o, {
        force: false
      }), o), e.remotes);
    }
    setIdToRemoteMap(e, r) {
      const { remote: n, expose: o } = r, { name: i, alias: a } = n;
    ...
    async loadRemote(e, r) {
      ...
      try {
        const { loadFactory: o = true } = r || {
          ...
          id: e
        }), { pkgNameOrAlias: l, remote: c, expose: u, id: d, remoteSnapshot: h } = s, m = await i.get(d, u, r, h), _ = await this.hooks.lifecycle.onLoad.emit({
          id: d,
          pkgNameOrAlias: l,
          expose: u,
    ...
    async preloadRemote(e) {
      ...
      await Promise.all(n.map(async (o) => {
        const { remote: i } = o, a = getRemoteInfo(i), { globalSnapshot: s, remoteSnapshot: l } = await r.snapshotHandler.loadRemoteSnapshotInfo({
          moduleInfo: i
    ...
    async getRemoteModuleAndOptions(e) {
      ...
      const { id: i } = o, a = matchRemoteWithNameAndExpose(r.options.remotes, i);
      ...
      let h = r.moduleCache.get(u.name);
      const m = {
        host: r,
        remoteInfo: l
      };
      return h || (h = new Module(m), r.moduleCache.set(u.name, h)), {
        module: h,
        moduleOptions: m,
        remoteMatchInfo: c
      };
    ...
    registerRemote(e, r, n) {
      ...
      if (!a) i(), r.push(e), this.hooks.lifecycle.registerRemote.emit({
        remote: e,
        origin: o
      });
      else {
        ...
        (n == null ? void 0 : n.force) && (this.removeRemote(a), i(), r.push(e), this.hooks.lifecycle.registerRemote.emit({
          remote: e,
          origin: o
        }), sdk.warn(s.join(" ")));
      }
    ...
    removeRemote(e) {
      try {
        const { host: n } = this, { name: o } = e, i = n.options.remotes.findIndex((s) => s.name === o);
        i !== -1 && n.options.remotes.splice(i, 1);
        const a = n.moduleCache.get(e.name);
        if (a) {
          ...
          globalLoading[c] && delete globalLoading[c], n.snapshotHandler.manifestCache.delete(s.entry);
          ...
          if (d !== -1) {
              ...
              I && Object.keys(I).forEach((b) => {
                ...
                S && Object.keys(S).forEach((E) => {
                  ...
                  R && Object.keys(R).forEach((T) => {
                    const $ = R[T];
                    $ && typeof $ == "object" && $.from === s.name && ($.loaded || $.loading ? ($.useIn = $.useIn.filter((M) => M !== s.name), $.useIn.length ? y = false : p.push([
                      g,
                      b,
                      E,
                      T
            ...
            }), y && (m.shareScopeMap = {}, delete _[u]), p.forEach(([g, I, b, S]) => {
              var E, R, T;
              (T = _[g]) == null || (R = T[I]) == null || (E = R[b]) == null || delete E[S];
            }), CurrentGlobal.__FEDERATION__.__INSTANCES__.splice(d, 1);
          }
          const { hostGlobalSnapshot: h } = getGlobalRemoteInfo(e, n);
          if (h) {
            const m = h && "remotesInfo" in h && h.remotesInfo && getInfoWithoutType(h.remotesInfo, e.name).key;
            m && (delete h.remotesInfo[m], Global.__FEDERATION__.__MANIFEST_LOADING__[m] && delete Global.__FEDERATION__.__MANIFEST_LOADING__[m]);
          }
          n.moduleCache.delete(e.name);
        }
      } catch (n) {
  ...
  class ModuleFederation {
    ...
    formatOptions(e, r) {
      const { shared: n } = formatShareConfigs(e, r), { userOptions: o, options: i } = this.hooks.lifecycle.beforeInit.emit({
        origin: this,
        userOptions: r,
        options: e,
        shareInfo: n
      }), a = this.remoteHandler.formatAndRegisterRemote(i, o), { shared: s } = this.sharedHandler.registerShared(i, o), l = [
        ...i.plugins
      ];
      o.plugins && o.plugins.forEach((u) => {
    ...
    registerPlugins(e) {
      ...
      this.options.plugins = this.options.plugins.reduce((n, o) => (o && n && !n.find((i) => i.name === o.name) && n.push(o), n), r || []);
    }
    registerRemotes(e, r) {
    ...
    constructor(e) {
      ...
      }), this.version = "0.17.1", this.moduleCache = /* @__PURE__ */ new Map(), this.loaderHook = new PluginSystem({
  ...
  function createInstance(t) {
    const e = runtimeCore.getGlobalFederationConstructor() || runtimeCore.ModuleFederation;
    return new e(t);
  }
  let FederationInstance = null;
  function init(t) {
    const e = utils.getGlobalFederationInstance(t.name, t.version);
    return e ? (e.initOptions(t), FederationInstance || (FederationInstance = e), e) : (FederationInstance = createInstance(t), runtimeCore.setGlobalFederationInstance(FederationInstance), FederationInstance);
  }
  ...
  vis2rssfeedWidgets__mf_v__runtimeInit__mf_v__ = {
    initPromise,
    initResolve
  };
})();
export {
  ...
  index_cjs$3 as a,
  init_1 as i,
  vis2rssfeedWidgets__mf_v__runtimeInit__mf_v__ as v
};
