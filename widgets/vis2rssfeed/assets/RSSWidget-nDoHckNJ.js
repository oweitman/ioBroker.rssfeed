...
import { V as g, e as p, I as f, __tla as __tla_3 } from "./ejs-D67t_4n6.js";
import { G as h, r as u } from "./rss-Boj54Q8q.js";
...
<% }); %> 
    ...
    renderWidgetBody(i) {
      ...
      o = o > 0 ? o : 1, e && e.articles && e.articles.length > o && (e.articles = e.articles.slice(0, o)), l !== "" && (e.articles = e.articles.filter((r) => this.checkHighlite(r.title + r.description + r.categories.toString(), l)));
      let a = "";
      try {
        typeof e.meta > "u" ? a = p.render(n, {}) : a = p.render(s, {
          rss: e,
          widgetid: i.id,
          style: i.style
        });
      } catch (r) {
        a = this.escapeHTML(r instanceof Error ? r.message : String(r)).replace(/(?:\r\n|\r|\n)/g, "<br>"), a = a.replace(/ /gm, "&nbsp;"), a = `<code style="color:red;">${a}</code>`;
      }
      return c.jsx(f, {
        html: a
      });
